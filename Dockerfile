...
# Accept a GitHub Packages token to install @gabriel20xx scoped packages
ARG NPM_TOKEN
ENV NODE_ENV=production PORT=8080

# Install production dependencies (configure GitHub registry first if token provided)
COPY package*.json ./
